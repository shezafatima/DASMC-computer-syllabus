...
function genProgramGoals() {
  const fm = frontMatter({
    title: 'Program Goals',
    sidebar_position: 1,
    description: 'Goals of the Digital & Future Skills Program at Dar-e-Arqam Metroville Campus.',
  });
  const content = `${fm}
...
Dar-e-Arqam Metroville Campus's Digital & Future Skills Program guides students from
